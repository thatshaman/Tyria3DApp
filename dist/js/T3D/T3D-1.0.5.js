                ...
                maps: [
                    {
                        ...
                        maps: [
                            ...
                            { fileName: "2164993.data", name: "Hoelbrak (2)" },
                    ...
                    {
                        name: "12. Icebrood Saga",
                        maps: [
                            { fileName: "2203371.data", name: "(E0) Grothmar Valley" },
                            { fileName: "2204239.data", name: "(E0) Grothmar Valley (story instance)" },
                            { fileName: "2251232.data", name: "(E1-2) Bjora Marches" },
                            { fileName: "2249817.data", name: "(E2) Drakkar (story instance)" },
                            { fileName: "2298865.data", name: "(E3) Drizzlewood Coast" },
                            { fileName: "2318029.data", name: "(E3-4) Drizzlewood Coast" },
                            { fileName: "2251447.data", name: "Eye of the North" },
                            { fileName: "2224355.data", name: "Voice & Claw of the Fallen" },
                            { fileName: "2224381.data", name: "Fraenir of Jormag" },
                            { fileName: "2224406.data", name: "Boneskinner" },
                            { fileName: "2251486.data", name: "Whisper of Jormag" },
                            { fileName: "2272807.data", name: "Forging Steel" },
                            { fileName: "2273128.data", name: "Darkrime Delves" },
                            { fileName: "2299088.data", name: "Cold War" }
                    ...
                    },
                    {
                        ...
                        maps: [
                            ...
                            { fileName: "2333932.data", name: "Sunqua Peak Fractal" }
                        ]
                    },
                    {
                        name: "16. Raid",
                    ...
                    },
                    {
                        ...
                        maps: [
                            ...
                            { fileName: "2128938.data", name: "Djinn's Dominion (0)" },
                    ...
                    },
                    {
                        ...
                        maps: [
                            ...
                            { fileName: "2257438.data", name: "Developer Map" },
                            { fileName: "2224545.data", name: "Jaga Moraine" },
                            { fileName: "2224624.data", name: "Jaga Moraine cave" }
                        ]
                    }
                ]
            };
